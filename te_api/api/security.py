...
@click.option('--site', 'site', help='Optional site ID to filter the safe route links by site...', type=int)
...
def get_safe_route(company_id, limit, offset, search, site):
    """Get the safe route link list"""
